...
<body>
      ...
      <div class="container">
            <header>
                  <h1>Categoría <?= $category['id_category'] ?></h1>
            </header>
            <main class="col-md-7">
                  <form role="form" action="<?= PATH ?>/Categories/update/<?= $category['id_category'] ?>" method="POST">
                        <input type="hidden" name="op" value="insertar" />
                        <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Campos requeridos</strong></div>
                        <div class="form-group mb-2">
                              <label for="id_category">Codigo de la categoría:</label>
                              <div class="input-group">
                                    <input type="text" class="form-control" name="id_category" id="id_category" placeholder="CAT###" value="<?= isset($category) ? $category['id_category'] : '' ?>" disabled>
