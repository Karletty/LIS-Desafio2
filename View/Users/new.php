...
<body>
      ...
      <div class="container">
            ...
            <main class="col-md-7">
                  <form role="form" action="<?= PATH ?>/Users/register" method="POST">
                        <input type="hidden" name="op" value="insertar" />
                        <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Campos requeridos</strong></div>
                        <div class="form-group mb-2">
                              <label for="user_name">Nombre del usuario:</label>
                              <div class="input-group">
                                    <input type="text" class="form-control" name="user_name" id="user_name" placeholder="Usuario" value="<?= isset($user) ? $user['user_name'] : '' ?>">
                        ...
                        <div class="form-group mb-2">
                              ...
                              if (isset($errors)  && isset($errors['pass'])) : ?>
                                    <div class="alert alert-danger mt-1"><?= $errors['pass'] ?></div>
                              <?php endif; ?>
                        </div>
